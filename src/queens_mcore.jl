		...
		for ii in 0:(num_threads-1)
			...
			Threads.@spawn begin
				...
				for j in 1:local_load
					...
					(local_number_of_solutions, local_partial_tree_size) = queens_tree_explorer_parallel(size, cutoff_depth, subproblems[s][1]#=.subproblem_is_visited=#, subproblems[s][2]#=.subproblem_partial_permutation=#)
