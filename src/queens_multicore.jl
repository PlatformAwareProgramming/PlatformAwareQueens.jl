...
@platform aware function queens({processor_core_count::(@atleast 2)}, size)
    ...
    @time queens_caller(size+1, cutoff_depth+1, num_threads)
...
#	println("N-Queens size: ", size, "\nNumber of threads: ", num_threads ,"\n###########################\n" ,"\nNumber of sols: ",number_of_solutions, "\nTree size: " ,partial_tree_size,"\n\n")
	(number_of_solutions, partial_tree_size)
end #caller