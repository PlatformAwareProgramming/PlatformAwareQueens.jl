...
function queens_distributed(size)
	...
	number_of_solutions, tree_size = queens_distributed_caller(size, number_of_subproblems, subproblems) 
...
function queens_distributed_caller(size, number_of_subproblems, subproblems) 
